...
class RocketWeb_ShoppingFeeds_Model_System_Config_Backend_Serialized_Mapproductcolumns extends Mage_Adminhtml_Model_System_Config_Backend_Serialized_Array
{
    /**
    ...
    {
        if ($this->hasFeed() &&
            $this->getFeed()->getType() === RocketWeb_ShoppingFeeds_Model_Feed_Type::TYPE_SHAREASALE) {
            return $value;
        }
