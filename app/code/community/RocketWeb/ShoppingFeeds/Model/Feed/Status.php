...
class RocketWeb_ShoppingFeeds_Model_Feed_Status extends Varien_Object
{
     ...
     * @return  RocketWeb_ShoppingFeeds_Model_Feed_Status
     */
    public function load(RocketWeb_ShoppingFeeds_Model_Feed $feed)
    {
