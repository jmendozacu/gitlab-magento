...
class RocketWeb_ShoppingFeeds_Model_Feed_Schedule extends Mage_Core_Model_Abstract
{

    protected function _construct()
    {
        $this->_init('rocketshoppingfeeds/feed_schedule');
    }
    ...
    public function getTimeFormatted($startAt = 0)
    {
        ...
        //$dateTime->setTimezone(Mage::getStoreConfig('general/locale/timezone', 0));
