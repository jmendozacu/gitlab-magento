 ...
 * @author    RocketWeb
 */
class RocketWeb_ShoppingFeeds_Model_Process extends Mage_Core_Model_Abstract
{
    ...
    {
        parent::_construct();
        $this->_init('rocketshoppingfeeds/process');
    }
    ...
    public function initialize()
    {
        if (!$this->hasId()) {
            $result = $this->getCollection()
                ...
                ->addFieldToFilter('feed_id', $this->getFeedId())
                ->load();
