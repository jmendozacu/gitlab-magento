 ...
 * @author    RocketWeb
 */
class RocketWeb_ShoppingFeeds_Model_Source_Directive_Concatenate extends Varien_Object
{

    public function toHtml()
    {
        $helper = Mage::helper('rocketshoppingfeeds');
        return '<textarea name="config[#{field_name}][#{_id}][param]" class="textarea" style="height: auto" rows="2" cols="10">#{param}</textarea>
