 ...
 * @author    RocketWeb
 */
class RocketWeb_ShoppingFeeds_Model_Source_Directive_Magic360 extends Varien_Object
{

    public function toHtml()
    {
        $helper = Mage::helper('rocketshoppingfeeds');
        return '<div style="float:left;">'. Mage::helper('rocketshoppingfeeds')->__('Main Image no (0001):'). '</div>
