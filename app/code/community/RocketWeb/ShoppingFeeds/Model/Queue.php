 ...
 * @author    RocketWeb
 */
class RocketWeb_ShoppingFeeds_Model_Queue extends Mage_Core_Model_Abstract
{
    public function _construct()
    {
        parent::_construct();
        $this->_init('rocketshoppingfeeds/queue');
    }
     ...
     * @param boolean | RocketWeb_ShoppingFeeds_Model_Feed_Schedule $schedule
     * @return $this
     */
    public function send(RocketWeb_ShoppingFeeds_Model_Feed $feed, $message = '', $schedule = false)
    {
    ...
    public function read()
    {
        ...
        /** @var RocketWeb_ShoppingFeeds_Model_Mysql4_Feed_Collection $collection */
