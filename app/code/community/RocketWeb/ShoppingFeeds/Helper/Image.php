 ...
 * @author    RocketWeb
 */
class RocketWeb_ShoppingFeeds_Helper_Image extends Mage_Catalog_Helper_Image
{
    ...
    {
        $this->_reset();
        $this->_setModel(Mage::getModel('rocketshoppingfeeds/product_image', array('store' => $this->_store)));
