 ...
 * @author    RocketWeb
 */
class RocketWeb_ShoppingFeeds_Helper_License extends Mage_Core_Helper_Abstract
{
    const XML_PATH_KEY = 'rocketweb_shoppingfeeds/general/license_key';
    ...
    public function activateLicense(Varien_Event_Observer $observer)
    {
        ...
        if ($config->getSection() !== 'rocketweb_shoppingfeeds') {
            return;
        }
