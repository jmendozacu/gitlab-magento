...
class RocketWeb_ShoppingFeeds_Block_Adminhtml_Feed extends Mage_Adminhtml_Block_Widget_Grid_Container
{
    /**
    ...
    public function __construct()
    {
        ...
        $this->_headerText = Mage::helper('rocketshoppingfeeds')->__('Manage Rocket Feeds');
        parent::__construct();

        $this->_removeButton('add');

//        $this->_addButton('run', array(
//            'label'     => Mage::helper('rocketshoppingfeeds')->__('Run All Feeds'),
//            'onclick'   => 'setLocation(\'' . $this->getUrl('*/*/generateall') .'\')',
//            'class'     => 'save',
//        ));
        $this->_addButton('add', array(
            'label'     => Mage::helper('rocketshoppingfeeds')->__('Add New Feed'),
    ...
    {
        if (count(Mage::getModel('rocketshoppingfeeds/feed_type')->getOptionArray())) {
