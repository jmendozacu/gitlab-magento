...
class RocketWeb_ShoppingFeeds_Block_Adminhtml_Form_Field_Select extends Varien_Data_Form_Element_Select
{
    public function getAfterElementHtml()
    {
        $currencies = Mage::getSingleton('rocketshoppingfeeds/source_currency')->getStoreOptionsArray();
        $html = '
