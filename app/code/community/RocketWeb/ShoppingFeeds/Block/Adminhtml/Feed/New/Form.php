...
class RocketWeb_ShoppingFeeds_Block_Adminhtml_Feed_New_Form extends Mage_Adminhtml_Block_Widget_Form
{
    /**
     * Setup form fields
     *
    ...
    protected function _prepareForm()
    {
        ...
        $fieldset->addField('type', 'select', array(
            ...
            'required'  => true,
            'values'    => Mage::getModel('rocketshoppingfeeds/feed_type')->getOptionArray(),
        ));
