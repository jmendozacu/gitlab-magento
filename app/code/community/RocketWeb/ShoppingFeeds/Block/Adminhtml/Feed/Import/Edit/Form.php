...
class RocketWeb_ShoppingFeeds_Block_Adminhtml_Feed_Import_Edit_Form extends Mage_Adminhtml_Block_Widget_Form
{
    /**
     * Add fieldset
     *
    ...
    protected function _prepareForm()
    {
        ...
        $fieldset->addField('entity', 'select', array(
            'name'     => 'entity',
            'title'    => Mage::helper('rocketshoppingfeeds')->__('Entity Type'),
            'label'    => Mage::helper('rocketshoppingfeeds')->__('Entity Type'),
            'required' => true,
            'values'   => Mage::getModel('rocketshoppingfeeds/source_import')->toOptionArray(),
        ...
        $fieldset->addField(Mage_ImportExport_Model_Import::FIELD_NAME_SOURCE_FILE, 'file', array(
            ...
            'label'    => Mage::helper('rocketshoppingfeeds')->__('Select File to Import'),
            'title'    => Mage::helper('rocketshoppingfeeds')->__('Select File to Import'),
            'required' => true,
