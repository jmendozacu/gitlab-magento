...
class RocketWeb_ShoppingFeeds_Block_Adminhtml_Feed_Edit_Tab_Options
    extends RocketWeb_ShoppingFeeds_Block_Adminhtml_Feed_Edit_Tab_Abstract
{
    protected function _prepareForm()
    {
        ...
        $this->addField('options_mode', 'select', array(
            ...
            'required'  => true,
            'values'    => Mage::getModel('rocketshoppingfeeds/source_product_option')->toOptionArray(),
        ...
        $this->getFieldset()->addType('options_vary_categories_type', Mage::getConfig()->getBlockClassName('rocketshoppingfeeds/adminhtml_form_element_category_option'));
