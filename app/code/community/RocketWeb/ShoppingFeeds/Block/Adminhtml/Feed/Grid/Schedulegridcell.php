 ...
 * Custom renderer
 */
class RocketWeb_ShoppingFeeds_Block_Adminhtml_Feed_Grid_Schedulegridcell extends Mage_Adminhtml_Block_Template
{
    ...
    {
        $this->setTemplate('rocketshoppingfeeds/grid/schedulegridcell.phtml');
        parent::_construct();
    }
    ...
    public function getEditUrl()
    {
        return $this->getUrl('*/*/edit', array('id' => $this->getFeed()->getId(),
            '_query' => array('active_tab' => 'rocketshoppingfeeds_schedule')));
    }
    ...
    public function getSchedules()
    {
        ...
        if (!array_key_exists($feedId, $this->_schedules)) {
            if ($this->getFeed()->getId()) {
                $this->_schedules[$feedId] = Mage::getResourceModel('rocketshoppingfeeds/feed_schedule_collection')
