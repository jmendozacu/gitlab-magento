...
class RocketWeb_ShoppingFeeds_Block_Adminhtml_Feed_Edit_Tab_Filters
    extends RocketWeb_ShoppingFeeds_Block_Adminhtml_Feed_Edit_Tab_Abstract
{
    protected function _prepareForm()
    {
        ...
        $this->addField('filters_product_types', 'multiselect', array(
            ...
            'values'    => Mage::getModel('rocketshoppingfeeds/source_producttypes')->toOptionArray(),
        ...
        $this->addField('filters_attribute_sets', 'multiselect', array(
            ...
            'values'    => Mage::getModel('rocketshoppingfeeds/source_attributesets')->toOptionArray(),
        ...
        $this->getFieldset()->addType('map_replace_empty_columns_type', Mage::getConfig()->getBlockClassName('rocketshoppingfeeds/adminhtml_form_element_emptycolumns'));
        $this->addField('filters_map_replace_empty_columns', 'map_replace_empty_columns_type', array(
            ...
            'after_element_html' => '<p class="note" style="width:450px;">'. $helper->__('Columns must exist in <a href="javascript:getAnchor(\'columns\',\'map_product_columns\');">Columns Map</a>. Save you config before looking for a new columns here. Grid has similar functions as <a href="javascript:getAnchor(\'columns\',\'map_product_columns\');">Columns Map</a>'). '</p><br />',
        ));

        $this->getFieldset()->addType('find_and_replace_type', Mage::getConfig()->getBlockClassName('rocketshoppingfeeds/adminhtml_form_element_findandreplace'));
        ...
        $this->addField('filters_skip_column_empty', 'multiselect', array(
            ...
            'values'    => Mage::getModel('rocketshoppingfeeds/source_feedcolumns')->toOptionArray(),
            'after_element_html' => '<p class="note" style="width:450px;">'. $helper->__('Avoid having empty values for your items in the feed.<br />Columns must exist in <a href="javascript:getAnchor(\'columns\',\'map_product_columns\');">Columns Map</a>, save your config before looking for columns here.'). '</p><br />',
        ));
        ...
        $this->getFieldset()->addType('adwords_price_buckets_type', Mage::getConfig()->getBlockClassName('rocketshoppingfeeds/adminhtml_form_element_mapprice'));
        ...
        $form->setValues(Mage::registry('rocketshoppingfeeds_feed')->getConfig());
