...
class RocketWeb_ShoppingFeeds_Block_Adminhtml_Feed_Edit_Tab_Grouped
    extends RocketWeb_ShoppingFeeds_Block_Adminhtml_Feed_Edit_Tab_Abstract
{
    protected function _prepareForm()
    {
        ...
        $this->addField('grouped_associated_products_mode', 'select', array(
            ...
            'required'  => true,
            'values'    => Mage::getModel('rocketshoppingfeeds/source_product_grouped_associated_mode')->toOptionArray(),
        ));
        ...
        $this->addField('grouped_price_display_mode', 'select', array(
            ...
            'required'  => true,
            'values'    => Mage::getModel('rocketshoppingfeeds/source_product_grouped_price')->toOptionArray(),
        ...
        $this->addField('grouped_associated_products_title', 'select', array(
            ...
            'required'  => true,
            'values'    => Mage::getModel('rocketshoppingfeeds/source_product_associated')->toOptionArray(),
        ));
        ...
        $this->addField('grouped_associated_products_link', 'select', array(
            ...
            'required'  => true,
            'values'    => Mage::getModel('rocketshoppingfeeds/source_product_grouped_associated_link')->toOptionArray(),
        ));
