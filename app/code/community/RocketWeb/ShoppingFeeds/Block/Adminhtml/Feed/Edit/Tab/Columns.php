...
class RocketWeb_ShoppingFeeds_Block_Adminhtml_Feed_Edit_Tab_Columns
    extends RocketWeb_ShoppingFeeds_Block_Adminhtml_Feed_Edit_Tab_Abstract
{
    protected function _prepareForm()
    {
        ...
        $this->getFieldset()->addType('map_product_columns_type', Mage::getConfig()->getBlockClassName('rocketshoppingfeeds/adminhtml_form_element_columns'));
