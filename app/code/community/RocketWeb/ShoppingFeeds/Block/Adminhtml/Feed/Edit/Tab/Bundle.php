...
class RocketWeb_ShoppingFeeds_Block_Adminhtml_Feed_Edit_Tab_Bundle
    extends RocketWeb_ShoppingFeeds_Block_Adminhtml_Feed_Edit_Tab_Abstract
{
    protected function _prepareForm()
    {
        ...
        $this->addField('bundle_associated_products_mode', 'select', array(
            ...
            'required'  => true,
            'values'    => Mage::getModel('rocketshoppingfeeds/source_product_bundle_associated_mode')->toArray(),
