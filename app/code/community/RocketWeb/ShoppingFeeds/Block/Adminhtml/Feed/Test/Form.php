...
class RocketWeb_ShoppingFeeds_Block_Adminhtml_Feed_Test_Form extends Mage_Adminhtml_Block_Widget_Form
{
...
$('btn_test_feed').observe('click', function (e) {
    ...
    protected function _prepareForm()
    {
        ...
        $fieldset = $form->addFieldset('input', array(
            'legend'    => Mage::helper('rocketshoppingfeeds')->__('Which product ?'),
        ));

        $fieldset->addField('sku', 'text', array(
            'name'      => 'sku',
            'label'     => Mage::helper('rocketshoppingfeeds')->__('SKU or ID'),
            'required'  => true,
            'after_element_html' => Mage::helper('rocketshoppingfeeds')->__('<br />SKU here must be is visible in catalog and enabled.
