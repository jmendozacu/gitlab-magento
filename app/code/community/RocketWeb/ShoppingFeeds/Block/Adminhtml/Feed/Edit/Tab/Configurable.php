...
class RocketWeb_ShoppingFeeds_Block_Adminhtml_Feed_Edit_Tab_Configurable
    extends RocketWeb_ShoppingFeeds_Block_Adminhtml_Feed_Edit_Tab_Abstract
{
    protected function _prepareForm()
    {
        ...
        $this->addField('configurable_associated_products_mode', 'select', array(
            ...
            'required'  => true,
            'values'    => Mage::getModel('rocketshoppingfeeds/source_product_associated_mode')->toOptionArray(),
        ...
        $this->addField('configurable_associated_products_link', 'select', array(
            ...
            'required'  => true,
            'values'    => Mage::getModel('rocketshoppingfeeds/source_product_associated_link')->toOptionArray(),
        ));
