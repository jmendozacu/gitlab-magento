 ...
 * @package  RocketWeb_ShoppingFeeds
 */
class RocketWeb_ShoppingFeeds_Block_Adminhtml_System_Config_Form_Field_Mapemptycolumns
    extends RocketWeb_ShoppingFeeds_Block_Adminhtml_System_Config_Form_Field_Mapproductcolumns
{
