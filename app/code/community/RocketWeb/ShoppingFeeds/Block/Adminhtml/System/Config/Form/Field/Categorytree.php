...
class RocketWeb_ShoppingFeeds_Block_Adminhtml_System_Config_Form_Field_Categorytree
    extends Mage_Adminhtml_Block_System_Config_Form_Field
{
    ...
    protected function _construct()
    {
        ...
        if(Mage::registry('rocketshoppingfeeds_feed_layout')) {
            $this->setLayout(Mage::registry('rocketshoppingfeeds_feed_layout'));
        }
    ...
    public function getNote() {
        return '<p class="note">'. $this->__('To include children categories:'). '
                ...
                <p class="note">'. $this->__('Please have your <b>Category Product Index</b> in the green for anchors to work as expected'). '</p><br />';
    }
}
