...
$installer->run("
DROP TABLE IF EXISTS {$this->getTable('rocketshoppingfeeds/feed')};
CREATE TABLE `{$this->getTable('rocketshoppingfeeds/feed')}` (
...
DROP TABLE IF EXISTS {$this->getTable('rocketshoppingfeeds/feed_config')};
CREATE TABLE `{$this->getTable('rocketshoppingfeeds/feed_config')}` (
	`id` int(11) unsigned NOT NULL auto_increment,
...
DROP TABLE IF EXISTS {$this->getTable('rocketshoppingfeeds/feed_schedule')};
CREATE TABLE `{$this->getTable('rocketshoppingfeeds/feed_schedule')}` (
  `id` int(11) unsigned NOT NULL AUTO_INCREMENT,
  `feed_id` int(11) unsigned NOT NULL,
...
DROP TABLE IF EXISTS {$this->getTable('rocketshoppingfeeds/queue')};
CREATE TABLE `{$this->getTable('rocketshoppingfeeds/queue')}` (
