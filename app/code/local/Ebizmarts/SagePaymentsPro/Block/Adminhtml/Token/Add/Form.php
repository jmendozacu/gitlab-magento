...
class Ebizmarts_SagePaymentsPro_Block_Adminhtml_Token_Add_Form extends Mage_Adminhtml_Block_Widget_Form
{
    protected function _prepareForm() 
    {
        $form = new Varien_Data_Form(
            array('id' => 'edit_form', 'action' =>
            $this->getUrl('adminhtml/token/saveadd'), 'method' => 'post')
        );
        $fieldset = $form->addFieldset(
            'base_fieldset', array('legend' =>
            Mage::helper('ebizmarts_sagepaymentspro')->__('Card Data'))
        );


        $fieldset->addField(
            'token_customerid', 'hidden', array(
