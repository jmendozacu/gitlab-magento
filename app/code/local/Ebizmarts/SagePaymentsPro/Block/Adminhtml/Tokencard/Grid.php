 ...
 */
class Ebizmarts_SagePaymentsPro_Block_Adminhtml_Tokencard_Grid
    extends Mage_Adminhtml_Block_Widget_Grid
{
    ...
    {
        return $this->getUrl(
            'adminhtml/token/add/new',
            array('customer_id' => Mage::registry('current_customer')->getId(),'popup'=>1)
        );
    }
