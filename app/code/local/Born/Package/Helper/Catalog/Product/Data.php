<?php 
class Born_Package_Helper_Catalog_Product_Data extends Mage_Core_Helper_Abstract
{
	...
	public function getProductTypeText($productId)
	{
		...
		$optionId = Mage::getModel('born_package/catalog_attribute_data')->getProductAttributeValue($productId, $attributeId);
	...
	public function getCanShowPrice($product)
	{
		...
		$_catalogPermissions = Mage::getModel('born_package/enterprise_catalog_permissions_data')->getProductPermission($product);
