<?php
class Born_BornIntegration_Model_Catalog_Product_Attribute_Tierprice_Api extends Mage_Catalog_Model_Product_Attribute_Tierprice_Api
{
    /**
    ...
    {
        //Mage::log(__METHOD__, false, 'Born_BornIntegration_Model_Catalog_Product_Attribute_Tierprice_Api_'.date('Ymd').'.log');
