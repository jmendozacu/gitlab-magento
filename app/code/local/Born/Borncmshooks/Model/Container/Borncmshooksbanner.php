<?php
class Born_Borncmshooks_Model_Container_Borncmshooksbanner extends Enterprise_PageCache_Model_Container_Abstract
{
 ...
 /**
    ...
    {
        //Mage::log($this->_placeholder->getAttribute('template'), null, 'cache.log');
