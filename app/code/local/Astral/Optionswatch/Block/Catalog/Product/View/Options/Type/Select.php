<?php 
class Astral_Optionswatch_Block_Catalog_Product_View_Options_Type_Select extends Mage_Catalog_Block_Product_View_Options_Type_Select
{
    /**
        ...
        if ($_option->getType() == Mage_Catalog_Model_Product_Option::OPTION_TYPE_RADIO
            ...
            foreach ($_option->getValues() as $_value) {
                ...
                $selectHtml .= '<li>' . '<input type="' . $type . '" class="' . $class . ' ' . $require
                    ...
                    . $this->escapeHtml($_value->getTitle());

                $selectHtml .= $_value->getMessage() ? ': <span class="message">' . $_value->getMessage() . '</span>' : '';

                if ($information = $_value->getInformation()) {
                    $selectHtml .= '<a data-coherent-modal data-modal-name="information-modal" class="information-icon"></a>';
                    $selectHtml .= '<div class="information-modal-content" style="display:none">';
                    $selectHtml .= $information;
                    $selectHtml .= '</div>';
                }
