...
class Astral_Optionswatch_Helper_Catalog_Product_List extends Mage_Core_Helper_Abstract
{
    ...
    public function getSubTextByEntityId($entityId)
    {
        if ($this->getShowSubtext() && $entityId) {
            ...
            $_model = Mage::getModel('astral_optionswatch/catalog_attribute_data');
