 ...
 */
class Amasty_Xcoupon_Adminhtml_Amxcoupon_ReportController extends Mage_Adminhtml_Controller_Action
{
    ...
    {
        return Mage::getSingleton('admin/session')->isAllowed('promo/amxcoupon');
    }
