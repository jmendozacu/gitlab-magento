...
Control.Rating = Class.create(
    ...
    (this.options.reverse ? $A(range).reverse() : range).each(
        function(i){
    ...
    if(this.options.input){
            if(this.options.input.options){
                $A(this.options.input.options).each(
                    function(option,i){
    ...
    if(!prevent_callbacks){
            if(this.options.updateUrl){
                ...
                a = new Ajax.Request(
                    this.options.updateUrl, Object.extend(
...
Object.extend(
    ...
    findByElementId: function(id){
        return Control.Rating.instances.find(
            function(instance){
