...
Control.Selection = {
    ...
    recalculateLayout: function(){
        Control.Selection.selectableElements.each(
            function(element){
    ...
    addSelectable: function(element,object,activation_targets,activation_target_callback){
        ...
        element._control_selection = {
            ...
            activationTargetMouseMove: function(){
                ...
                if(activation_targets){
                    activation_targets.each(
                        function(activation_target){
    ...
    removeSelectable: function(element){
        ...
        if(element._control_selection.activation_targets){
            element._control_selection.activation_targets.each(
                function(activation_target){
    ...
    select: function(selected_elements){
        ...
        var selected_items_have_changed = !(Control.Selection.elements.length == selected_elements.length && Control.Selection.elements.all(
            function(item,i){
        ...
        var selected_objects = selected_elements.collect(
    ...
    onMouseMove: function(event){
        if(!Control.Selection.active){
            ...
            var current_selection = Control.Selection.selectableElements.findAll(
                function(element){
            ...
            if(event.shiftKey && !event.altKey){
                ...
                current_selection = Control.Selection.elements.findAll(
                    function(element){
    ...
    DragProxy: {
        ...
        start: function(event){            
            ...
            Control.Selection.DragProxy.container._draggable = new Draggable(
                Control.Selection.DragProxy.container,Object.extend(
                    {
