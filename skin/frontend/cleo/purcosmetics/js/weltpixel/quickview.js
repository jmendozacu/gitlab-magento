        ...
        addToCart: function(url, data, addOptions)
        {
            ...
            new Ajax.Request(url, {
                ...
                onSuccess: function(transport, json) {
                    if (!transport.responseJSON.error_message) {
                        ...
                        setTimeout(function(){
                            var miniCart = $$('.mini-cart')[0];
                            miniCart.addClassName('mini-cart-open');
                            weltpixel.lightbox.close();
                        }, 100);

                    } else {
                        setTimeout(function(){
                            weltpixel.lightbox.close();
                            alert(transport.responseJSON.error_message);
                        }, 100);
                    }
