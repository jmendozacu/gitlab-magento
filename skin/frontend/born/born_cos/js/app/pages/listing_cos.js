  ...
  var ListingView = Backbone.View.extend({
    initialize: function () {
      ...
      this.bindOpenFilter_mobile = function () {
        ...
        filterContainer.find('.filter-title').off('click.custom');
        filterContainer.find('.filter-title').on('click.custom', function (e) {
      ...
      $('#filters-wrapper').find('.btnx').on('click', function (e) {
        e.preventDefault();
        $('.btnx').removeClass('btn-open');
      });
    ...
    initFiltres: function () {
      ...
      $('.input-box.filter').find('label.label-text').on('click', function () {
        ...
        loader.attr('src', '../../skin/frontend/rwd/born/images/PUR_loader.gif');
        ...
        $.get(url, function (data) {})
          .done(function (data) {
            ...
            require(["../../born/js/app/pages/common"], function (common) {
              common.initialize();
            });
