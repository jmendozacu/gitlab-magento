...
(function($) {
	console.log("jQuery Form Styler Init");
	'use strict';
	...
	var pluginName = 'styler',
			defaults = {
				wrapper: 'form',
				idSuffix: '-styler',
				filePlaceholder: "File isn't selected",
				fileBrowse: 'Browse...',
...
//console.log(el.0);
            ...
            dropdown.isDropdownInSampleOnCart = ul.parents('.checkout-cart-index').length && ul.parents('.bx-wrapper').length;
            ...
            if (el.data('placeholder') && el.val() === '') {
              ...
              divText.text(optionSelected.text());
              ...
              else if (dropdown.isDropdownInSampleOnCart) {
                var dropdownTop = -(dropdown.outerHeight());
                ...
                if (bottomOffset > (minHeight + searchHeight + 20)) {
						...
						if (!dropdown.isDropdownInSampleOnCart)	preventScrolling(ul);
